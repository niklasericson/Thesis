...
\end{equation}
and the control law parameters are calculated as outlined below where \eta are tuning variables.
\begin{equation}
  \label{eq:adaplaws1}
