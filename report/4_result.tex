...
\begin{figure}[h!]
  ...
  \qquad
  \subfloat[][Impact on 130Hz component]{
...
\begin{figure}[h!]
  ...
  \caption{\label{fig:rfdc_model_error} Shows the effect of the feedforward disturbance cancellation with the mean of the acquired response added as disturbance (a) and one period of the acquired response added as disturbance (b).}
\end{figure}
...
These equations where augmented according to \eqref{eq:augumented} with the discrete time system matrices which can be seen in its full form in Appendix A. The observer was implemented in state space form, with the following equations.
...
\begin{table}[h!]
  ...
  \begin{tabular}{| l | P{3.7cm} | P{2.2cm} | P{2.2cm} | P{2.2cm} |}
    ...
    3 & Robustness to model errors (model's 1st resonance at 28.2Hz), attenuation-[\%] & 40.5 & 26.6 & 73.5\\ \hline
    4 & Robustness to model errors (model's 1st resonance at 43.4Hz), attenuation-[\%] & 57.7 & 5.0 & 83.4\\ \hline
...
\begin{table}[h!]
  ...
  \begin{tabular}{| l | P{4cm} | P{2.2cm} | P{2.2cm} | P{2.2cm} |}
    ...
    2 & Tracking error, periodic input $\sigma$-[mrads] & $0.29$ & $0.03$ & $0.11$\\ \hline
    3 & Robustness to model errors (model's 1st resonance at 22.0Hz), $\sigma$-[mrads] & $\infty$, unstable & 0.03 & 0.21\\ \hline
    4 & Robustness to model errors (model's 1st resonance at 67.2Hz), $\sigma$-[mrads] & $\infty$, unstable & 0.03 & 0.11\\ \hline
    5 & Robustness to model errors (model's 1st resonance at 17.6Hz), $\sigma$-[mrads] & $\infty$, unstable & $\infty$, unstable & 0.47\\ \hline
    6 & Robustness to model errors (model's 1st resonance at 77.7Hz), $\sigma$-[mrads] & $\infty$, unstable & $\infty$, unstable & 0.11\\ \hline
    7 & Output disturbance rejection, settling time (1\%) [ms] & 8 & 25 & 260\\ \hline
    8 & Stability issues & Unstable with high model errors & Unstable with high model errors, but better than present & Good adaption even with model errors, but tuning for quicker adaption easily leads to instability\\ \hline
    9 & Implementation considerations & Straightforward technique, allowing for basic stability and robustness analysis & Same as present & Hard to tune. No high order models. Stability only proven in continuous time. \\ \hline
  \end{tabular}
