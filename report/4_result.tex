...
\begin{figure}[h!]
  ...
  \caption{\label{fig:model_dist_high_order} Cancellation of the 200Hz component. The time domain response is shown in (a) where the cancellation is added after 2s. The \abbrFFT of (a) from t=2.5s to t=5s is shown in (b).}
\end{figure}
...
\begin{figure}[h!]
  ...
  \caption{\label{fig:model_dist_high_order} Cancellation of the 60Hz, 90Hz and the 200Hz component. The time domain response is shown in (a) where the cancellation is added after 2s. The \abbrFFT of (a) from t=2.5s to t=5s is shown in (b).}
\end{figure}

\begin{figure}[h!]
  \centering
  \includegraphics[width=0.7\textwidth]{fig/matlab/3real_dist_fft.eps}
  \caption{\label{fig:high_model_error} \abbrFFT of the added perturbation with and without cancellation of the 60Hz, 90Hz and the 200Hz component.}
\end{figure}
...
\begin{figure}[h!]
  ...
  \caption{\label{fig:model_dist_high_order} Shows the convergence (a) of the 200Hz observed harmonic with $Q_1 = diag(10, 0)$. The \abbrFFT of (a) is shown in (b), showing a clean model of the 200 Hz component.}
\end{figure}
...
\begin{figure}[h!]
  ...
  \caption{\label{fig:model_dist_high_order} Shows the convergence (a) of the 200Hz observed harmonic with $Q_1 = diag(70, 0)$. The \abbrFFT of (a) is shown in (b), including a lot of other frequency components in the 200 Hz harmonic model.}
\end{figure}
