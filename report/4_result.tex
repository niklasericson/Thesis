...
\begin{table}[h!]
  ...
  \begin{tabular}{| p{4cm} | p{2cm} | p{2cm} | p{2cm} |}
    \hline
        & Present & \abbrIRC & \abbrMRACPE \\ \hline
    Closed-loop Bandwidth [Hz] & 9.7 & 73.3 & -\\ \hline
    $\sigma$ - tracking error [mrads] & $0.29$ & $0.03$ & $0.11$\\ \hline
    $\sigma$ - tracking error with model change [mrads] & $0.60$ & $0.22$ & $0.11$\\ \hline
    Robustness model errors & $-$ & $-$ & $-$\\ \hline
    Stability issues & $-$ & tuning for faster adaption easily leads to instability & $-$\\ \hline
  \end{tabular}
...
\begin{table}[h!]
  ...
  \begin{tabular}{| l | l | l | l |}
    \hline
        & \abbrFDC & \abbrRFDC & \abbrIMP \\ \hline
    Affecting closed loop system & No & No & Yes\\
    Cancellation effectiveness & $1$ & $R$ & $1$\\
    Robustness to model errors & $1$ & $R$ & $1$\\
    Implementation simplicity & $1$ & $R$ & $1$\\
    \hline
  \end{tabular}
