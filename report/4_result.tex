...
\begin{figure}[h!]
  ...
  \includegraphics[width=0.46\textwidth, trim=0cm 0cm 1cm 1cm, clip=true]{fig/matlab/ff_impulse.eps}}
  \qquad
  \subfloat[][\label{fig:stepout}Mean of impulse responses]{
  \includegraphics[ width=0.46\textwidth, trim=0cm 0cm 1cm 1cm, clip=true]{fig/matlab/yaw_angle_mean_1_step_s.eps}}
...
\begin{figure}[h!]
  ...
  \includegraphics[width=0.46\textwidth, trim=0cm 0cm 0.9cm 0.5cm, clip=true]{fig/matlab/fft_mean_in_out_0V.eps}}
  \qquad
  \subfloat[][\abbrFFT at 3.25V]{
  \includegraphics[width=0.46\textwidth, trim=0cm 0cm 0.9cm 0.5cm, clip=true]{fig/matlab/fft_mean_in_out_3V.eps}}
...
\begin{figure}[h!]
  ...
  \includegraphics[width=0.46\textwidth, trim=0cm 0cm 1cm 0.5cm, clip=true]{fig/matlab/fft_mean_in_out_6_5V.eps}}
  \qquad
  \subfloat[][\label{fig:distmodelfit}Identified model]{
  \includegraphics[width=0.46\textwidth, trim=0cm 0cm 1cm 0.5cm, clip=true]{fig/matlab/model_fit_1step_s.eps}}
