\begin{notation}% Passing the option "old" to the notation environment will redefine the notationtabular environment so that it produces an old style LaTeX tabular instead of a ctable.sty style tabular.
  ...
  \begin{notationtabular}{Abbreviations}{Abbreviation}{Meaning}
    \abbrCERN\index{CERN@\abbrCERN!abbreviation} & European Council for Nuclear Research \\
    \abbrENSTIECE\index{ENSTIECE@\abbrENSTIECE!abbreviation} & Engineering Department - Source, Target and Interaction Group - Equipment and Controls Section \\
    ...
    \abbrPXI\index{PXI@\abbrPXI!abbreviation} & Peripheral component interconnect eXtensions for Instrumentation\\
  \end{notationtabular}
\end{notation}
