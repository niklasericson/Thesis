...
\begin{frame}{Beat effect}
  ...
  \begin{figure}[h!]
    \centering %crop: left bottom right top
    \subfloat[][]{
    \includegraphics[width=0.5\textwidth]{../fig/matlab/yl_closedloop_ext_disturbance_80Hz_2}} \\ {\color{white} -} \\ \vspace{-1cm}
    \subfloat[][]{
    \includegraphics[width=0.3\textwidth]{../fig/matlab/beat_effect_yl}}
    \subfloat[][]{
    \includegraphics[width=0.3\textwidth]{../fig/matlab/beat_effect}}
